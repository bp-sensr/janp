...
::: figure-grid
![Tekarra 9 2023](assets/tekarra9-2024.png){width="48%"} ![Tekarra 9 2025](assets/tekarra9-2025.png){width="48%"}
...
In the forest model selection, the candidate model set was again ranked via BIC but included the following ecoregion-specific variables: scaled variables for year, shrub cover, conifer cover, broadleaf cover, mixedwood cover, water cover, human (urban and road surface), herbaceous cover (graminoid, mixed and forbs), and rock and soil (bedrock, exposed soil). The burned class exclusive to TEKARRA and VALLEY5 locations in 2026 was added to models but created complexity in the models by variance inflation factor testing.
